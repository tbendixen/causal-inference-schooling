...
We then fit and compare two approaches to modeling years of formal education and age -- namely, via Gaussian processes and monotonic effects. Then, we fit our main analysis, as reported in the submitted manuscript and compare the marginal predictions to a model that poststratify predictions to a different, non-sampled population.
...
cite_packages(dependencies = TRUE, output = "paragraph")
